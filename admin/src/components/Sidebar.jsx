  ...
  return (
    <div className="w-[18%] min-h-screen border-r-2">
      <div className="flex flex-col gap-4 pt-6 pl-[20%] text-[15px]">
        ...
        <NavLink
          className="flex items-center gap-3 border border-amber-300 bg-amber-50/50 border-r-0 px-3 py-2 rounded-l group hover:bg-amber-50"
          to="/special-offers"
        >
          ...
          <div className="hidden md:block text-left">
            <p className="font-bold text-amber-950 text-[14px]">Festival Offers</p>
            <p className="text-[10px] text-amber-600 -mt-0.5">Campaigns & Deals</p>
          </div>
        </NavLink>
        <NavLink
          className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l"
        ...
        >
          ...
          <p className="hidden md:block">Customers & Letters</p>
        </NavLink>
        <NavLink
          className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l"
          to="/loyalty-levels"
        >
          ...
          <p className="hidden md:block">Loyalty Levels</p>
        </NavLink>
        <NavLink
          className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l"
          to="/categories"
        >
          <img className="w-5 h-5" src={assets.add_icon} alt="" />
          <p className="hidden md:block">Categories & Types</p>
        </NavLink>
        <NavLink
          className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l"
          to="/reviews"
        ...
        >
          ...
          <p className="hidden md:block">Shipment Rates</p>
        </NavLink>
      </div>
    </div>
  );
